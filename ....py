...
Original file is located at
    https://colab.research.google.com/drive/1RudmrBwthIBozsq3HkNmVwXU8TolHhKR
"""
...
bike_df = pd.read_csv('/content/submission/data/bike_df_data.csv')
bike2_df = pd.read_csv('/content/submission/data/bike2_df_data.csv')
